...
from paginas.mixins import PaletaColorMixin, LogoMixin

"""TODO: min_num debe ser mínimo 1 en QA y prod"""


@register_setting
class ConfiguracionSitio(BaseSiteSetting, LogoMixin, PaletaColorMixin):
    ...
    api_fields = LogoMixin.api_fields + PaletaColorMixin.api_fields + [
        APIField('site_id'),
    ...
    content_panels = PaletaColorMixin.content_panels + []
